...
set_input_delay -clock [get_clocks clk] -min -add_delay 3.500 [get_ports {k_j[*]}]
set_input_delay -clock [get_clocks clk] -max -add_delay 3.600 [get_ports {k_j[*]}]
set_input_delay -clock [get_clocks clk] -min -add_delay 3.000 [get_ports {num_queries[*]}]
set_input_delay -clock [get_clocks clk] -max -add_delay 3.200 [get_ports {num_queries[*]}]
set_input_delay -clock [get_clocks clk] -min -add_delay 3.500 [get_ports {q_i[*]}]
set_input_delay -clock [get_clocks clk] -max -add_delay 3.600 [get_ports {q_i[*]}]
set_input_delay -clock [get_clocks clk] -min -add_delay 3.500 [get_ports rst_]
set_input_delay -clock [get_clocks clk] -max -add_delay 3.600 [get_ports rst_]
set_input_delay -clock [get_clocks clk] -min -add_delay 3.500 [get_ports start]
set_input_delay -clock [get_clocks clk] -max -add_delay 3.600 [get_ports start]
set_output_delay -clock [get_clocks clk] -min -add_delay 1.000 [get_ports {dk_idx[*]}]
set_output_delay -clock [get_clocks clk] -max -add_delay 2.000 [get_ports {dk_idx[*]}]
set_output_delay -clock [get_clocks clk] -min -add_delay 1.000 [get_ports {key_idx[*]}]
set_output_delay -clock [get_clocks clk] -max -add_delay 2.000 [get_ports {key_idx[*]}]
set_output_delay -clock [get_clocks clk] -min -add_delay 1.000 [get_ports {softmax_idx[*]}]
set_output_delay -clock [get_clocks clk] -max -add_delay 2.000 [get_ports {softmax_idx[*]}]
set_output_delay -clock [get_clocks clk] -min -add_delay 1.000 [get_ports {softmax_j[*]}]
set_output_delay -clock [get_clocks clk] -max -add_delay 2.000 [get_ports {softmax_j[*]}]
...
set_output_delay -clock [get_clocks clk] -min -add_delay 1.000 [get_ports valid_out]
set_output_delay -clock [get_clocks clk] -max -add_delay 2.000 [get_ports valid_out]
...
set_input_delay -clock [get_clocks *] 4.000 [get_ports start]

set_operating_conditions -design_power_budget 0.5

reset_switching_activity -all 
set_switching_activity -deassert_resets 
set_switching_activity -default_toggle_rate 12.500
set_switching_activity -default_static_probability 0.500
...
set_switching_activity -toggle_rate 20.000 -type {shift_register} -static_probability 0.500 -all 
set_switching_activity -toggle_rate 20.000 -type {dsp} -static_probability 0.500 -all 
